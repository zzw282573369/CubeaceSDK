#
#  Be sure to run `pod spec lint CubeaceSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/zzw282573369/CubeaceSDK"
  ...
  spec.source       = { :git => "https://github.com/zzw282573369/CubeaceSDK.git", :tag => "#{spec.version}" }
